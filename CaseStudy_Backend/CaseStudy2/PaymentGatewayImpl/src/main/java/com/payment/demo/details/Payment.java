package com.payment.demo.details;
...
public class Payment {
		...
		public Payment(String merchantId, String merchantKey, String channelId, String website, String industryTypeId,
		...
		public String toString() {
			return "Payment [merchantId=" + merchantId + ", merchantKey=" + merchantKey + ", channelId=" + channelId
