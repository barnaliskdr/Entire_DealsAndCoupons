...
public class Companyservices {
	...
	public ResponseEntity<String> servicedeleteCouponsBycompanyId(String company_id){
	...
	public ResponseEntity<?> serviceupdateById(Company company,String company_id){
	...
	public Company servicegetdetailsbyId(String id) {
