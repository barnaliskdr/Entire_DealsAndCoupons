...
function About() {
   return (
    <div className="aboutdesign">
      <center><h1 style={{ color:"Highlight", fontFamily:"cursive"}}>Our Company</h1></center>
      <br></br>
      <div className="aboutstyle">
        <center><h2 style={{color: "red", fontFamily:"cursive"}}> Our Vision </h2></center>
        <p class="para" style={{color: "brown",fontFamily:"cursive"}}>
