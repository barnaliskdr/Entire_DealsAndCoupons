...
import Getdetailsbycompanyname from "./components/GetDetailsCompanyName";
import Companylogin from "./components/company-login-board";
    ...
    return (
      <div>
        ...
        {/* /*"navbar navbar-expand navbar-dark bg-dark">*/ }
          ...
          <div className="navbar-nav mr-auto" style={{marginLeft: "760px"}}>
           ...
           <li className="nav-item">
            ...
            {/* //when currentusr will be true and others showcompanyBoard and showAdminBoard are false then only
            // 119-123 no line will be showing.When company logs in showcompanyBoard is true and currentuser is also true.
            //So condition will be true && false && true */}
            {currentUser && !showCompanyBoard && !showAdminBoard && (
              <li className="nav-item">
        ...
        <Routes>
            ...
            <Route exact path="/complogin" element={<Companylogin />} />
