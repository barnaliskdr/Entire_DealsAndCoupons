...
const deleteCouponById = (comp_uid) =>
{
 ...
 service.deleteCoupon(comp_uid).then((reponse)=>{
  window.alert("do u want to delete?");
...
return(
  ...
  <br></br>
  <br></br>
  <button className="btn btn-success" style={{marginleft:"1000px", fontFamily:"cursive"}} onClick={addcoupon} >AddCoupon</button>
  <br></br>
  <br></br>
  <center><table className="tabledesign" style={{color:"Highlight", fontFamily:"cursive"}}border={3}>
